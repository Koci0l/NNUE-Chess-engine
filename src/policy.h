...
// Quiet move-ordering blend: score += int(bonus)
// bonus is in [0, POLICY_QUIET_WEIGHT] for quiets
...
struct PolicyNet {
    ...
    // quantised.bin L1 layout is [out][in] (verified vs trainer)
