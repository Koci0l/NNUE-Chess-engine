...
// ============================================================================
// Policy architecture:
// 3072 -> 8192 -> crelu -> pairwise -> 4096 -> 1024 -> crelu -> 7840
// ============================================================================
...
#define KOCIOLEK_POLICY_HL 8192
#endif

constexpr int POLICY_HL          = KOCIOLEK_POLICY_HL;
static_assert(POLICY_HL > 0 && (POLICY_HL % 2) == 0, "POLICY_HL must be positive and even");

constexpr int POLICY_HL_PAIR     = POLICY_HL / 2;    // 4096
constexpr int POLICY_HL2         = 1024;
constexpr int POLICY_OUTPUT_MOVES = 7840;
...
struct PolicyNet {
    ...
    // Debug / layout toggles.
    bool l2_out_major    = true;  // output layer layout
    bool l1_hidden_major = false;  // hidden layer layout
    bool see_invert      = false; // invert good/bad SEE half
    bool feat_swap       = false; // swap threat/defence feature planes
    int  act_mode        = 0;     // 0=crelu01, 1=relu, 2=identity, 3=screlu01
